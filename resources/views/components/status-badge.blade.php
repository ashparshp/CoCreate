...
$colors = [
    'default' => [
        'planning' => 'bg-secondary-100 text-secondary-900 dark:bg-secondary-700/60 dark:text-secondary-300',
    ...
    'task' => [
        'to_do' => 'bg-secondary-100 text-secondary-900 dark:bg-secondary-700/60 dark:text-secondary-300',
        'in_progress' => 'bg-primary-100 text-primary-800 dark:bg-primary-900/60 dark:text-primary-300',
    ...
    'visibility' => [
        ...
        '0' => 'bg-secondary-100 text-secondary-900 dark:bg-secondary-700/60 dark:text-secondary-300',
        'false' => 'bg-secondary-100 text-secondary-900 dark:bg-secondary-700/60 dark:text-secondary-300',
    ]
];

$typeMap = $colors[$type] ?? $colors['default'];
$colorClass = $typeMap[$status] ?? 'bg-secondary-100 text-secondary-900 dark:bg-secondary-700/60 dark:text-secondary-300';
