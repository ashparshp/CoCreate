        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('projects.update', $project) }}">
                    ...
                    <div class="mb-4">
                        <label for="status" class="block text-sm font-medium text-gray-700">{{ __('Project Status') }}</label>
                    ...
                    <div class="flex justify-end">
                        <a href="{{ route('projects.show', $project) }}" class="bg-gray-200 text-gray-800 px-4 py-2 rounded mr-2">
                            {{ __('Cancel') }}
                        </a>
