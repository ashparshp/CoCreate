            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                <form method="POST" action="{{ route('projects.tasks.store', $project) }}">
                    ...
                    <div class="flex justify-end">
                        <a href="{{ route('projects.tasks.index', $project) }}" class="bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600 px-4 py-2 rounded mr-2">
                            {{ __('Cancel') }}
                        </a>
